...
//ol.proj.get("EPSG:4326").setExtent([-5.352759, 36.129491, -5.349437, 36.132810]);
var wms_layers = [];
...
var format_Succulents_17 = new ol.format.GeoJSON();
var features_Succulents_17 = format_Succulents_17.readFeatures(json_Succulents_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Succulents_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Succulents_17.addFeatures(features_Succulents_17);
var lyr_Succulents_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Succulents_17, 
                style: style_Succulents_17,
                popuplayertitle: "Succulents",
                interactive: true,
                title: '<img src="styles/legend/Succulents_17.png" /> Succulents'
            });
var format_Vines_18 = new ol.format.GeoJSON();
var features_Vines_18 = format_Vines_18.readFeatures(json_Vines_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Vines_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Vines_18.addFeatures(features_Vines_18);
var lyr_Vines_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vines_18, 
                style: style_Vines_18,
                popuplayertitle: "Vines",
                interactive: true,
                title: '<img src="styles/legend/Vines_18.png" /> Vines'
            });
var format_Wild_plants_19 = new ol.format.GeoJSON();
var features_Wild_plants_19 = format_Wild_plants_19.readFeatures(json_Wild_plants_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Wild_plants_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Wild_plants_19.addFeatures(features_Wild_plants_19);
var lyr_Wild_plants_19 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Wild_plants_19, 
                style: style_Wild_plants_19,
                popuplayertitle: "Wild_plants",
                interactive: true,
                title: '<img src="styles/legend/Wild_plants_19.png" /> Wild_plants'
            });
var format_WildlifePark_20 = new ol.format.GeoJSON();
var features_WildlifePark_20 = format_WildlifePark_20.readFeatures(json_WildlifePark_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_WildlifePark_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_WildlifePark_20.addFeatures(features_WildlifePark_20);
var lyr_WildlifePark_20 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_WildlifePark_20, 
                style: style_WildlifePark_20,
                popuplayertitle: "Wildlife Park",
                interactive: true,
                title: '<img src="styles/legend/WildlifePark_20.png" /> Wildlife Park'
            });
var format_Theatrefull_21 = new ol.format.GeoJSON();
var features_Theatrefull_21 = format_Theatrefull_21.readFeatures(json_Theatrefull_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Theatrefull_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Theatrefull_21.addFeatures(features_Theatrefull_21);
var lyr_Theatrefull_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Theatrefull_21, 
                style: style_Theatrefull_21,
                popuplayertitle: "Theatrefull",
                interactive: true,
                title: '<img src="styles/legend/Theatrefull_21.png" /> Theatrefull'
            });
var format_Northpaths_22 = new ol.format.GeoJSON();
var features_Northpaths_22 = format_Northpaths_22.readFeatures(json_Northpaths_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Northpaths_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Northpaths_22.addFeatures(features_Northpaths_22);
var lyr_Northpaths_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Northpaths_22, 
                style: style_Northpaths_22,
                popuplayertitle: "North paths",
                interactive: true,
                title: '<img src="styles/legend/Northpaths_22.png" /> North paths'
            });
var format_Gardensextent_23 = new ol.format.GeoJSON();
var features_Gardensextent_23 = format_Gardensextent_23.readFeatures(json_Gardensextent_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Gardensextent_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Gardensextent_23.addFeatures(features_Gardensextent_23);
var lyr_Gardensextent_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Gardensextent_23, 
                style: style_Gardensextent_23,
                popuplayertitle: "Gardens extent",
                interactive: true,
                title: '<img src="styles/legend/Gardensextent_23.png" /> Gardens extent'
            });
var format_Office_area_24 = new ol.format.GeoJSON();
var features_Office_area_24 = format_Office_area_24.readFeatures(json_Office_area_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Office_area_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Office_area_24.addFeatures(features_Office_area_24);
var lyr_Office_area_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Office_area_24, 
                style: style_Office_area_24,
                popuplayertitle: "Office_area",
                interactive: true,
                title: '<img src="styles/legend/Office_area_24.png" /> Office_area'
            });
var format_Mothtrap_25 = new ol.format.GeoJSON();
var features_Mothtrap_25 = format_Mothtrap_25.readFeatures(json_Mothtrap_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Mothtrap_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Mothtrap_25.addFeatures(features_Mothtrap_25);
var lyr_Mothtrap_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Mothtrap_25, 
                style: style_Mothtrap_25,
                popuplayertitle: "Moth trap",
                interactive: true,
                title: '<img src="styles/legend/Mothtrap_25.png" /> Moth trap'
            });
...
lyr_OSMStandard_0.setVisible(true);lyr_Pathsoriginal_1.setVisible(true);lyr_Stairs_2.setVisible(true);lyr_Generalveg_3.setVisible(true);lyr_Cannons_4.setVisible(true);lyr_Beds_5.setVisible(true);lyr_Merged_6.setVisible(true);lyr_Educationareas_7.setVisible(true);lyr_Dogpark_8.setVisible(true);lyr_Buildings_9.setVisible(true);lyr_Plantcollection_10.setVisible(true);lyr_Water_11.setVisible(true);lyr_ChildrensPark_12.setVisible(true);lyr_Statues_13.setVisible(true);lyr_TheDell_14.setVisible(true);lyr_Theatre_15.setVisible(true);lyr_Bridge_16.setVisible(true);lyr_Succulents_17.setVisible(true);lyr_Vines_18.setVisible(true);lyr_Wild_plants_19.setVisible(true);lyr_WildlifePark_20.setVisible(true);lyr_Theatrefull_21.setVisible(true);lyr_Northpaths_22.setVisible(true);lyr_Gardensextent_23.setVisible(true);lyr_Office_area_24.setVisible(true);lyr_Mothtrap_25.setVisible(true);lyr_Shrubs_26.setVisible(true);lyr_Aloes_27.setVisible(true);lyr_Bulbs_allies_28.setVisible(true);lyr_Epipytes_allies_29.setVisible(true);lyr_Grasses_allies_30.setVisible(true);lyr_Herbaceous_31.setVisible(true);lyr_Palms_cycads_al_32.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_Pathsoriginal_1,lyr_Stairs_2,lyr_Generalveg_3,lyr_Cannons_4,lyr_Beds_5,lyr_Merged_6,lyr_Educationareas_7,lyr_Dogpark_8,lyr_Buildings_9,lyr_Plantcollection_10,lyr_Water_11,lyr_ChildrensPark_12,lyr_Statues_13,lyr_TheDell_14,lyr_Theatre_15,lyr_Bridge_16,lyr_Succulents_17,lyr_Vines_18,lyr_Wild_plants_19,lyr_WildlifePark_20,lyr_Theatrefull_21,lyr_Northpaths_22,lyr_Gardensextent_23,lyr_Office_area_24,lyr_Mothtrap_25,lyr_Shrubs_26,lyr_Aloes_27,lyr_Bulbs_allies_28,lyr_Epipytes_allies_29,lyr_Grasses_allies_30,lyr_Herbaceous_31,lyr_Palms_cycads_al_32];
...
lyr_Succulents_17.set('fieldAliases', {'Plantnames': 'Plantnames', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Accession': 'Accession', });
lyr_Vines_18.set('fieldAliases', {'Plantname': 'Plantname', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Accession': 'Accession', });
lyr_Wild_plants_19.set('fieldAliases', {'Plantname': 'Plantname', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Accession': 'Accession', });
lyr_WildlifePark_20.set('fieldAliases', {'id': 'id', 'Type': 'Type', });
lyr_Theatrefull_21.set('fieldAliases', {'id': 'id', 'Type': 'Type', });
lyr_Northpaths_22.set('fieldAliases', {'id': 'id', });
lyr_Gardensextent_23.set('fieldAliases', {'id': 'id', });
lyr_Office_area_24.set('fieldAliases', {'id': 'id', });
lyr_Mothtrap_25.set('fieldAliases', {'id': 'id', });
...
lyr_Succulents_17.set('fieldImages', {'Plantnames': '', 'Latitude': '', 'Longitude': '', 'Accession': '', });
lyr_Vines_18.set('fieldImages', {'Plantname': '', 'Latitude': '', 'Longitude': '', 'Accession': '', });
lyr_Wild_plants_19.set('fieldImages', {'Plantname': '', 'Latitude': '', 'Longitude': '', 'Accession': '', });
lyr_WildlifePark_20.set('fieldImages', {'id': 'TextEdit', 'Type': 'TextEdit', });
lyr_Theatrefull_21.set('fieldImages', {'id': 'TextEdit', 'Type': 'TextEdit', });
lyr_Northpaths_22.set('fieldImages', {'id': 'TextEdit', });
lyr_Gardensextent_23.set('fieldImages', {'id': 'TextEdit', });
lyr_Office_area_24.set('fieldImages', {'id': 'TextEdit', });
lyr_Mothtrap_25.set('fieldImages', {'id': 'TextEdit', });
...
lyr_Succulents_17.set('fieldLabels', {'Plantnames': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Accession': 'no label', });
lyr_Vines_18.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Accession': 'no label', });
lyr_Wild_plants_19.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Accession': 'no label', });
lyr_WildlifePark_20.set('fieldLabels', {'id': 'no label', 'Type': 'no label', });
lyr_Theatrefull_21.set('fieldLabels', {'id': 'no label', 'Type': 'no label', });
lyr_Northpaths_22.set('fieldLabels', {'id': 'no label', });
lyr_Gardensextent_23.set('fieldLabels', {'id': 'no label', });
lyr_Office_area_24.set('fieldLabels', {'id': 'no label', });
lyr_Mothtrap_25.set('fieldLabels', {'id': 'no label', });
lyr_Shrubs_26.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Accession': 'no label', });
lyr_Aloes_27.set('fieldLabels', {'Plant name': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Accession': 'no label', });
lyr_Bulbs_allies_28.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'no label', 'Longitude': 'header label - visible with data', 'Accession': 'header label - visible with data', });
lyr_Epipytes_allies_29.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'hidden field', 'Longitude': 'no label', 'Accession': 'no label', });
lyr_Grasses_allies_30.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'header label - visible with data', 'Longitude': 'hidden field', 'Accession': 'no label', });
lyr_Herbaceous_31.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'header label - always visible', 'Longitude': 'header label - always visible', 'Accession': 'no label', });
lyr_Palms_cycads_al_32.set('fieldLabels', {'Plantname': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Accession': 'no label', });
